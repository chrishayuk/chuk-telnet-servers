#!/usr/bin/env python3
# telnet_server/handlers/character_handler.py
"""
...
from telnet_server.utils.terminal_codes import CR, LF, CRLF, ERASE_CHAR

# Create logger for this module
logger = logging.getLogger('telnet-character')
