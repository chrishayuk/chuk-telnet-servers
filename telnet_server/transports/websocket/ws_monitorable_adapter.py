#!/usr/bin/env python3
# telnet_server/transports/websocket/ws_monitorable_adapter.py
"""
...
logger = logging.getLogger('ws-monitorable-adapter')
...
class MonitorableWebSocketAdapter(WebSocketAdapter):
    ...
    def __init__(self, websocket: WebSocketServerProtocol, handler_class: Type[BaseHandler]):
        ...
        from telnet_server.transports.websocket.ws_monitorable_reader import MonitorableWebSocketReader
        import uuid
