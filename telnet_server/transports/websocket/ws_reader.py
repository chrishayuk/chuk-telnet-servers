#!/usr/bin/env python3
# telnet_server/transports/websocket/ws_reader.py
"""
...
from telnet_server.transports.transport_adapter import StreamReaderAdapter

# Configure logging
logger = logging.getLogger('websocket-reader')
