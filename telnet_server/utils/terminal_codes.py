...
def set_color(fg=None, bg=None, *effects) -> bytes:
    """
    ...
    Args:
        ...
        *effects: Additional text effects (from Color class)
...
def get_colored_text(text: str, fg=None, bg=None, *effects) -> bytes:
    """
    ...
    """
    return set_color(fg, bg, *effects) + text.encode() + reset_colors()
